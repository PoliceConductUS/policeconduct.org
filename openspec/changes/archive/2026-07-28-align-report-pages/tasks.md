...
- [x] 1.3 Extend the report-detail loader to expose the newly displayed fields (submitter relationship, incident time, interaction type, setting, complaint filed, case number, bodycam requested, feelings, charges) — each nullable, rendered only when present.
