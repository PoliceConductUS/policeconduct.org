...
Personnel detail pages should not link to or generate a personnel agencies scoped subpage when the personnel record is associated with only one distinct agency. In that case, the main personnel page already provides enough agency context. Generate and link `/personnel/{slug}/agencies/` only when the personnel record has more than one distinct associated agency.
